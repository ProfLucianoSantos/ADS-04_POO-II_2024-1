...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $cliente = new Cliente(1, $nome, $cpf, $rg, $telefone, $tipoCliente);
        $veiculo = new Veiculo($numPlaca, $marca, $modelo);
        $ordemServico = new OrdemServico($numOs, $dataEntrada, null);
        $servico = new Servico(1, $descricaoServico, $valorServico);
